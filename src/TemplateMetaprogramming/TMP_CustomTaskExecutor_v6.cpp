...
#include "TMP_CustomTaskExecutor_v6.h"
...
namespace mm {
	...
	namespace customTaskExecutor_v6 {
		...
		{
			testCustomTaskExecutor<CustomTaskExecutor::Task>();
			...
			CustomTaskExecutor::Task<std::string, double>::addTask("fun1", cStyleFunStringDouble);
			std::string s1 = CustomTaskExecutor::Task<std::string, double>::runTask("fun1", dIn);

			CustomTaskExecutor::Task<std::string, std::string, const std::string, std::string&, const std::string&, std::string&&>::addTask("fun2", cStyleFunStrStrConstStrRefStrConstRefStrRValRefStr);
			std::string s2 = CustomTaskExecutor::Task<std::string, std::string, const std::string, std::string&, const std::string&, std::string&&>::runTask("fun2", s, cs, rs, crs, "rvrs");
	...
	MM_DECLARE_FLAG(TemplateMetaProgrammingCustomTaskExecutor_v6);

	MM_UNIT_TEST(TemplateMetaProgrammingCustomTaskExecutorTest_v6, TemplateMetaProgrammingCustomTaskExecutor_v6)
	{
		customTaskExecutor_v6::testAllCustomTaskExecutorVersions();
	}
}
